...
export default function ({ projectDir }) {
    try {
        ...
        pkg.scripts = {
            ...pkg.scripts,
            "generate_drizzle": "drizzle-kit generate",
            "drizzle_migrate": "drizzle-kit migrate",
            "drizzle_push": "drizzle-kit push",
            "drizzle_studio": "drizzle-kit studio"
        };
        pkg.dependencies = {
            ...pkg.dependencies,
            "drizzle-orm": "0.45.2",
        ...
        const exportLine = 'export { drizzle } from "@/app/lib/drizzle";\n';
